...
ret.Add(wts[i].Multiply(v)));
 ...
 180);
      EInteger w2 = Interpolate(wts, new int[] { -120, 1, 1, -4, -4, 0, 6, },
 24);
      EInteger w3 = Interpolate(wts, new int[] { 45, -1, 0, 27, -7, -1, 45, },
 18);
      EInteger w4 = Interpolate(wts, new int[] { 96, -1, -1, 16, 16, 0, -30, },
 24);
