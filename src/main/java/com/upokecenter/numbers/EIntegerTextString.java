      ...
      if (radix == 10) {
        ...
        for (int i = ei; i < endIndex; ++i) {
          ...
          if (i < endIndex - 3) {
            ...
            int d1 = (int)cs.charAt(i) - 0x30;
            int d2 = (int)cs.charAt(i + 1) - 0x30;
            int d3 = (int)cs.charAt(i + 2) - 0x30;
            int d4 = (int)cs.charAt(i + 3) - 0x30;
            i += 3;
