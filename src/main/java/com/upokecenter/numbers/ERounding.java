 ...
 */
  ...
  public enum ERounding {
    ...
    /**
     * Rounded to the nearest number; if the fractional part is exactly half, the
     * number is rounded to the closest representable number that is even. This is
     * sometimes also known as "banker's rounding".
     */
    HalfEven,
...
@Deprecated
     ...
     * (including decimal numbers), this is the same as ZeroFiveUp. This rounding
     * mode is useful for rounding intermediate results at a slightly higher
     * precision (at least 2 bits more for binary) than the final precision.
     */
    OddOrZeroFiveUp,
  }
