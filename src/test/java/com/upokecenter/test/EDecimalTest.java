...
import com.upokecenter.numbers.*;
 ...
 Assert.fail();
      ...
      Assert.assertEquals(
        ...
        EDecimal.FromString("0.009461540475412139260145553670698466186015902447450593622262751970123371581303298477485466592231565609"));
      if (!(
        EDecimal.FromString("0.009461540475412139260145553670698466186015902447450593622262751970123371581303298477485466592231565609")).equals(EDecimal.FromString("0.001809476049361792727571247490438259768858020288404502743164967883090669271207537395819291033916115474"))) {
 Assert.fail((
        EDecimal.FromString("0.009461540475412139260145553670698466186015902447450593622262751970123371581303298477485466592231565609"))+" not equal to "+(EDecimal.FromString("0.001809476049361792727571247490438259768858020288404502743164967883090669271207537395819291033916115474")));
}
      RandomGenerator r = new RandomGenerator();
      for (int i = 0; i < 500; ++i) {
        EDecimal bigintA = RandomObjects.RandomEDecimal(r);
