...
import com.upokecenter.numbers.*;
 ...
 Assert.fail();
  ...
  EInteger.FromString("9461540475412139260145553670698466186015902447450593622262751970123371581303298477485466592231565609");
      ...
      if (!(
  EInteger.FromString("9461540475412139260145553670698466186015902447450593622262751970123371581303298477485466592231565609")).equals(EInteger.FromString("1809476049361792727571247490438259768858020288404502743164967883090669271207537395819291033916115474"))) {
 Assert.fail((
  EInteger.FromString("9461540475412139260145553670698466186015902447450593622262751970123371581303298477485466592231565609"))+" not equal to "+(EInteger.FromString("1809476049361792727571247490438259768858020288404502743164967883090669271207537395819291033916115474")));
}
